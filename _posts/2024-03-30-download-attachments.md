...
When you run the script, it creates an “Attachments” folder in the same location. It then neatly organizes all downloaded attachments in a folder hierarchy by table name and record display value. It also helpfully adds appropriate file extensions to any files that don’t have them.
